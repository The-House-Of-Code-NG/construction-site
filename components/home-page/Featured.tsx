...
const HompageFeatured = ({ data }: { data?: any }) => {
  return (
    ...
    <div className="mb-8 md:flex md:items-start md:justify-between md:gap-16 lg:gap-20 lg:mb-10">
        ...
        <li key={index} className="group rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition">
        <Image
            src={project.image[0]}
            alt={project.title}
        ...
        <div className="p-4 bg-white">
            ...
            <p className="text-sm text-appGray-300">{project.description}</p>
        </div>
        </li>
    ))}
            </ul>
